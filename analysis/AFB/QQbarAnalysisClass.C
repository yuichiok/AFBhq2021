...
void QQbarAnalysisClass::AFB_energyDependence(int n_entries=-1, int bkg=0, float Kvcut=35, float acol_cut=0.35)
{
  ...
  TH1F * h_AFBb_acol15_com[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  TH1F * h_AFBb_acol15[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  ...
  TH1F * h_AFBc_acol15_com[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  TH1F * h_AFBc_acol15[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  ...
  TH1F * h_AFBuds_acol15_com[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  TH1F * h_AFBuds_acol15[150];// = new TH1F("h_AFB","h_AFB",40,-1,1);
  ...
  for(int i=0;i<150;i++) {
    ...
    h_AFBb_acol15_com[i] = new TH1F(TString::Format("h_AFBb_COM_acol15_KLowerThan%i",i),TString::Format("h_AFBb_COM_acol15_KLowerThan%i",i),40,-1,1);
    h_AFBb_acol15[i] = new TH1F(TString::Format("h_AFBb_acol15_KLowerThan%i",i),TString::Format("h_AFBb_KLowerThan%i",i),40,-1,1);
    ...
    h_AFBc_acol15_com[i] = new TH1F(TString::Format("h_AFBc_COM_acol15_KLowerThan%i",i),TString::Format("h_AFBc_COM_acol15_KLowerThan%i",i),40,-1,1);
    h_AFBc_acol15[i] = new TH1F(TString::Format("h_AFBc_acol15_KLowerThan%i",i),TString::Format("h_AFBc_KLowerThan%i",i),40,-1,1);
    ...
    h_AFBuds_acol15_com[i] = new TH1F(TString::Format("h_AFBuds_COM_acol15_KLowerThan%i",i),TString::Format("h_AFBuds_COM_acol15_KLowerThan%i",i),40,-1,1);
    h_AFBuds_acol15[i] = new TH1F(TString::Format("h_AFBuds_acol15_KLowerThan%i",i),TString::Format("h_AFBuds_KLowerThan%i",i),40,-1,1);
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	h_AFBuds_K35_com[i]->Fill(costheta_ccbar_COM);
      ...
      if(fabs(mc_quark_pdg[0])==5 && gamma_e<i && acol<15./100.) {
	h_AFBb_acol15[i]->Fill(costheta_ccbar);
	h_AFBb_acol15_com[i]->Fill(costheta_ccbar_COM);
      }
      if(fabs(mc_quark_pdg[0])==4 && gamma_e<i && acol<15./100.) {
	h_AFBc_acol15[i]->Fill(costheta_ccbar);
	h_AFBc_acol15_com[i]->Fill(costheta_ccbar_COM);
      }
      if(fabs(mc_quark_pdg[0])<4 && gamma_e<i && acol<15./100.) {
	h_AFBuds_acol15[i]->Fill(costheta_ccbar);
	h_AFBuds_acol15_com[i]->Fill(costheta_ccbar_COM);
      }
  ...
  for(int i=0;i<150;i++) {
    ...
    h_AFBb_acol15_com[i]->Write();
    h_AFBb_acol15[i]->Write();
    ...
    h_AFBc_acol15_com[i]->Write();
    h_AFBc_acol15[i]->Write();
    ...
    h_AFBuds_acol15_com[i]->Write();
    h_AFBuds_acol15[i]->Write();
  }
