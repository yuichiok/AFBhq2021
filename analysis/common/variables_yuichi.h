// Declaration of leaf types
   ...
   Int_t           pfo_pdgcheat_id[2000];   //[pfo_n]
   Int_t           pfo_nparents[2000];   //[pfo_n]
   Int_t           pfo_pdgcheat_parent[2000][1000];   //[pfo_n]
   ...
   Float_t         pfo_vtxpt[2000][3];   //[pfo_n]
   Float_t         pfo_endpt[2000][3];   //[pfo_n]
   Int_t           pfo_pid[2000];   //[pfo_n]
   Float_t         pfo_pid_likelihood[2000];   //[pfo_n]
   Float_t         pfo_pid_eprob[2000];   //[pfo_n]
   Float_t         pfo_pid_muprob[2000];   //[pfo_n]
   Float_t         pfo_pid_piprob[2000];   //[pfo_n]
   Float_t         pfo_pid_kprob[2000];   //[pfo_n]
   Float_t         pfo_pid_pprob[2000];   //[pfo_n]
   Float_t         pfo_pid_hprob[2000];   //[pfo_n]
   Int_t           pfo_piddedx[2000];   //[pfo_n]
   Float_t         pfo_piddedx_likelihood[2000];   //[pfo_n]
   Float_t         pfo_piddedx_eprob[2000];   //[pfo_n]
   Float_t         pfo_piddedx_muprob[2000];   //[pfo_n]
   Float_t         pfo_piddedx_piprob[2000];   //[pfo_n]
   Float_t         pfo_piddedx_kprob[2000];   //[pfo_n]
   Float_t         pfo_piddedx_pprob[2000];   //[pfo_n]
   Float_t         pfo_piddedx_hprob[2000];   //[pfo_n]
   ...
   Float_t         pfo_piddedx_e_lkhood[2000];   //[pfo_n]
   Float_t         pfo_piddedx_mu_lkhood[2000];   //[pfo_n]
   Float_t         pfo_piddedx_pi_lkhood[2000];   //[pfo_n]
   Float_t         pfo_piddedx_k_lkhood[2000];   //[pfo_n]
   Float_t         pfo_piddedx_p_lkhood[2000];   //[pfo_n]
   Float_t         pfo_pidtof_p_at_calo[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_0ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_10ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_50ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_100ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_0ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_10ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_50ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_100ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_0ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_10ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_50ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_100ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_0ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_10ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_50ps[2000];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_100ps[2000];   //[pfo_n]
