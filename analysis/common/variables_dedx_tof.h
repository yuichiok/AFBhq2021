...
Int_t           pfo_n_j2;
Int_t           jet_nvtx_j2;
Int_t           pfo_match[9999];   //[pfo_n]
Int_t           pfo_truejet_pdg[9999];   //[pfo_n]
Int_t           pfo_truejet_type[9999];   //[pfo_n]
Int_t           pfo_pdgcheat[9999];   //[pfo_n]
Float_t         pfo_E[9999];   //[pfo_n]
Float_t         pfo_px[9999];   //[pfo_n]
Float_t         pfo_py[9999];   //[pfo_n]
Float_t         pfo_pz[9999];   //[pfo_n]
Float_t         pfo_m[9999];   //[pfo_n]
Int_t           pfo_type[9999];   //[pfo_n]
Int_t           pfo_isoverlay[9999];   //[pfo_n]
Int_t           pfo_isisr[9999];   //[pfo_n]
Int_t           pfo_vtx[9999];   //[pfo_n]
Int_t           pfo_charge[9999];   //[pfo_n]
Int_t           pfo_ntracks[9999];   //[pfo_n]
Int_t           pfo_tpc_hits[9999];   //[pfo_n]
Float_t         pfo_dedx[9999];   //[pfo_n]
Float_t         pfo_dedxerror[9999];   //[pfo_n]
Float_t         pfo_d0[9999];   //[pfo_n]
Float_t         pfo_d0error[9999];   //[pfo_n]
Float_t         pfo_z0[9999];   //[pfo_n]
Float_t         pfo_z0error[9999];   //[pfo_n]
Float_t         pfo_phi[9999];   //[pfo_n]
Float_t         pfo_phierror[9999];   //[pfo_n]
Float_t         pfo_omega[9999];   //[pfo_n]
Float_t         pfo_omegaerror[9999];   //[pfo_n]
Float_t         pfo_tanlambda[9999];   //[pfo_n]
Float_t         pfo_tanlambdaerror[9999];   //[pfo_n]
Float_t         pfo_chi2[9999];   //[pfo_n]
Float_t         pfo_ndf[9999];   //[pfo_n]
Int_t           pfo_pid[9999];   //[pfo_n]
Float_t         pfo_pid_likelihood[9999];   //[pfo_n]
Float_t         pfo_pid_eprob[9999];   //[pfo_n]
Float_t         pfo_pid_muprob[9999];   //[pfo_n]
Float_t         pfo_pid_piprob[9999];   //[pfo_n]
Float_t         pfo_pid_kprob[9999];   //[pfo_n]
Float_t         pfo_pid_pprob[9999];   //[pfo_n]
Float_t         pfo_pid_hprob[9999];   //[pfo_n]
Int_t           pfo_piddedx[9999];   //[pfo_n]
Float_t         pfo_piddedx_likelihood[9999];   //[pfo_n]
Float_t         pfo_piddedx_eprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_muprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_piprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_kprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_pprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_hprob[9999];   //[pfo_n]
Float_t         pfo_piddedx_e_dedxdist[9999];   //[pfo_n]
Float_t         pfo_piddedx_mu_dedxdist[9999];   //[pfo_n]
Float_t         pfo_piddedx_pi_dedxdist[9999];   //[pfo_n]
Float_t         pfo_piddedx_k_dedxdist[9999];   //[pfo_n]
Float_t         pfo_piddedx_p_dedxdist[9999];   //[pfo_n]
Float_t         pfo_piddedx_e_lkhood[9999];   //[pfo_n]
Float_t         pfo_piddedx_mu_lkhood[9999];   //[pfo_n]
Float_t         pfo_piddedx_pi_lkhood[9999];   //[pfo_n]
Float_t         pfo_piddedx_k_lkhood[9999];   //[pfo_n]
Float_t         pfo_piddedx_p_lkhood[9999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_0ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_10ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_50ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_100ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_0ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_10ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_50ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_100ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_0ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_10ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_50ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_100ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_0ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_10ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_50ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_100ps[9999];   //[pfo_n]
Float_t         pfo_pidtof_p_at_calo[9999];   //[pfo_n]
