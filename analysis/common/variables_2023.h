...
Float_t pfo_piddedx_k_dedxdist_improved_1[9999];  //[pfo_n]
Float_t pfo_piddedx_k_dedxdist_improved_2[9999];  //[pfo_n]
...
TBranch *b_pfo_piddedx_k_dedxdist_improved_1;  //!
TBranch *b_pfo_piddedx_k_dedxdist_improved_2;  //!
...
void SetBranchAddressFunction(TTree *fChain)
{
  ...
  fChain->SetBranchAddress("pfo_piddedx_k_dedxdist_improved_1", pfo_piddedx_k_dedxdist_improved_1, &b_pfo_piddedx_k_dedxdist_improved_1);
  fChain->SetBranchAddress("pfo_piddedx_k_dedxdist_improved_2", pfo_piddedx_k_dedxdist_improved_2, &b_pfo_piddedx_k_dedxdist_improved_2);
