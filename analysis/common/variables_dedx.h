  // Declaration of leaf types
   ...
   Int_t           mc_quark_ps_n;
   Float_t         mc_quark_ps_E[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_px[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_py[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pz[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_m[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pdg[999];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_charge[999];   //[mc_quark_ps_n]
