...
int test_selection( TString file="", TString process="2f_hadronic", TString pol="eL", int file_n=0, int type=4, int bkg=0){
  ...
  ss3.Selection(-1,type,50,bkg);
  if(type<1) ss3.SelectionParticleLevel(-1,type,50,bkg);
  gSystem->Exit(0);
