...
void Labels(int i = 0, int ipol = 1, float lum = 900, float ildx=0.86)
{
  ...
  if (ipol == 2)
    QQBARLabel2(0.7, 0.03, "e_{L}^{-}e_{R}^{+}(80,30) ", kGray + 1);
  if (ipol == 3)
    QQBARLabel2(0.7, 0.03, "e_{R}^{-}e_{L}^{+}(80,30)", kGray + 1);
}
...
std::vector<TH1F *> GetHisto1D(TString sample = "2f_hadronic_sample", int ipol = 0, int ibkg = 0, float lum = 900, std::vector<TString> histonames={"h_mjj","h_mj1_mj2","h_y23","h_d23","h_thrust","h_major_thrust","h_minor_thrust"} )
{
...
std::vector<TH1F *> GetHisto1D_2(TString sample = "qq_radreturn", int ipol = 0, int ibkg = 0, float lum = 900, std::vector<TString> histonames={"h_mjj","h_mj1_mj2","h_y23","h_d23","h_thrust","h_major_thrust","h_minor_thrust"} )
{
...
std::vector<TH2F *> GetHisto2D_2(TString sample = "qq_radreturn", int ipol = 0, int ibkg = 0, float lum = 900, std::vector<TString> histonames={"h_major_minor_thrust","h_costheta_energy","h_npfos"}) 
{
